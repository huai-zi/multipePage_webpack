  ...
  export default {
    ...
    mounted() {
      ...
      document.querySelector(".login-button").onclick = function () {
        that.addClass(document.querySelector(".login"), "active")
        setTimeout(function () {
          that.addClass(document.querySelector(".sk-rotating-plane"), "active")
          document.querySelector(".login").style.display = "none"
        }, 800)
        setTimeout(function () {
          that.removeClass(document.querySelector(".login"), "active")
          that.removeClass(document.querySelector(".sk-rotating-plane"), "active")
